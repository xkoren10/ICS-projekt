...
namespace RideShare.Common.Tests.Seeds
{
    ...
    public static class RideSeeds
    {
        ...
        public static readonly RideEntity RideWithPassngersUpdate = RideEntity with { Id = Guid.Parse("4FD824C0-A7D1-48BA-8E7C-4F136CF8BF31"), Ingredients = Array.Empty<IngredientAmountEntity>() };
        public static readonly RideEntity RideWithPassngersDelete = RideEntity with { Id = Guid.Parse("F78ED923-E094-4016-9045-3F5BB7F2EB88"), Ingredients = Array.Empty<IngredientAmountEntity>() };
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RideEntity>().HasData(
                ...
                RideEntityUpdate,
                RideEntityDelete,
                RideWithPassngersUpdate,
                RideWithPassngersDelete
            );
        } 
    }
}